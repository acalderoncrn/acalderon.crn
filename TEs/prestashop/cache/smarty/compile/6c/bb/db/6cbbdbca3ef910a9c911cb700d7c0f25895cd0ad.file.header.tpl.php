<?php /* Smarty version Smarty-3.1.19, created on 2017-03-15 19:08:49
         compiled from "/Users/acalderon/Google Drive/AGS2 (1)/M08/m08calderon/TEs/prestashop/themes/pf_fashion_store/header.tpl" */ ?>
<?php /*%%SmartyHeaderCode:162531410358c98331531b88-24549458%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '6cbbdbca3ef910a9c911cb700d7c0f25895cd0ad' => 
    array (
      0 => '/Users/acalderon/Google Drive/AGS2 (1)/M08/m08calderon/TEs/prestashop/themes/pf_fashion_store/header.tpl',
      1 => 1489601285,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '162531410358c98331531b88-24549458',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_58c98331609821_53756583',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_58c98331609821_53756583')) {function content_58c98331609821_53756583($_smarty_tpl) {?><?php if (!is_callable('smarty_function_implode')) include '/Users/acalderon/Google Drive/AGS2 (1)/M08/m08calderon/TEs/prestashop/tools/smarty/plugins/function.implode.php';
?>
<!DOCTYPE HTML>
...
<?php }?>
		...
		<link rel="stylesheet" href="http<?php if (Tools::usingSecureMode()) {?>s<?php }?>://fonts.googleapis.com/css?family=Arapey:400,400italic" rel="stylesheet" type="text/css" media="all">
			...
			<div class="header-container">
				<header id="header">
					...
					<div class="nav">
						<div class="container">
							<div class="row">
								<div class="show-desktop quick-access">
									<div class=""><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['hook'][0][0]->smartyHook(array('h'=>"displayNav"),$_smarty_tpl);?>
</div>
								</div>
							</div>
						</div>
...
<?php }?>
			...
			<?php if ($_smarty_tpl->tpl_vars['page_name']->value=='category') {?>
				<?php echo $_smarty_tpl->getSubTemplate (((string)$_smarty_tpl->tpl_vars['tpl_dir']->value)."./category_image.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array(), 0);?>
			...
			<div class="columns-container">
				<div id="columns" class="container">
					...
					<?php }?>
					<?php if ($_smarty_tpl->tpl_vars['page_name']->value=='category'||$_smarty_tpl->tpl_vars['page_name']->value=='new-products'||$_smarty_tpl->tpl_vars['page_name']->value=='manufacturer'||$_smarty_tpl->tpl_vars['page_name']->value=='best-sales'||$_smarty_tpl->tpl_vars['page_name']->value=='supplier'||$_smarty_tpl->tpl_vars['page_name']->value=='prices-drop') {?>
						<div class="content_sortPagiBar clearfix">
							<div class="sortPagiBar row">										
								<div class="col-lg-5">		<?php echo $_smarty_tpl->getSubTemplate ("./nbr-product-page.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array(), 0);?>
</div>
								<div class="col-lg-7">		<?php echo $_smarty_tpl->getSubTemplate ("./product-sort.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array(), 0);?>
</div>
							</div>
						</div>
					<?php }?>
